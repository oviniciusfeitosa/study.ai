...
llm_model = ChatOllama(model=os.environ['OPENAI_MODEL_NAME'], temperature=0, verbose=True)
...
BrowserTool().scrape_and_summarize_website("https://pt.wikipedia.org/wiki/Rio_de_Janeiro")